...
def render(root: Path) -> tuple[str, dict[str, object]]:
    ...
    lines = [
        ...
        "//============================================================",
        "",
        "malangdo,141,137,2\tscript\tCostume Roulette\t4_M_MERCAT2,{",
        '\tmes "[Costume Roulette]";',
        '\tmes "Choose a costume part, then I will spin only that drawer.";',
        '\tmes "One Silvervine Fruit buys one spin.";',
        ...
        '\tif (.@count <= 0) {',
        '\t\tmes "That drawer is empty.";',
        '\t\tclose;',
        "\t}",
        '\tif (countitem(6417) < 1) {',
        '\t\tmes "Bring me one Silvervine Fruit.";',
        '\t\tclose;',
        "\t}",
        ...
        '\t\tmes "Make room in your inventory first. I cannot guarantee the costume and pity reward if your bag is full.";',
        '\t\tclose;',
        "\t}",
        '\tif (.@first_spin) {',
        '\t\tmes "Spend one Silvervine Fruit for this spin?";',
        '\t\tif (select("Spin:Cancel") == 2) close;',
        '\t\t.@first_spin = 0;',
        '\t}',
        '\tif (countitem(6417) < 1) {',
        '\t\tmes "You no longer have a Silvervine Fruit.";',
        '\t\tclose;',
        "\t}",
        '\tdelitem 6417, 1;',
        '\tgetitem .@id, 1;',
        '\t#COSTUME_ROULETTE_PITY = #COSTUME_ROULETTE_PITY + 1;',
        '\tmes "You received ^0055FF" + getitemname(.@id) + "^000000.";',
        '\tif (#COSTUME_ROULETTE_PITY >= 20) {',
        '\t\t#COSTUME_ROULETTE_PITY = 0;',
        '\t\tgetitem 7051, 1;',
        '\t\tmes "Your 20-spin pity is complete. You received ^0055FFSilk Mat^000000.";',
        "\t}",
        '\tnext;',
